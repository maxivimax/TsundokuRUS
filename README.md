...
Создатель: [TylerGibbs2](https://github.com/tylergibbs2) <br>
Переводчик на русский: [Maxivimax](https://github.com/maxivimax)
...
* Python 3.7+
* [Deluge WebAPI Plugin](https://github.com/idlesign/deluge-webapi) или [qBittorrent](https://www.qbittorrent.org/) с включенным WebUI
* PostgreSQL 9+
...
Скопировать `config.ini.example` в `config.ini` и после [сконфигурировать](#Конфигурация).
